...
def load_data():
    f = open('../../../data/Data for Neural Networks/M1_DeepSquat/Train_X1.csv')
    csv_f = csv.reader(f)
    Train_X = list(csv_f)
    ...
    f = open('../../../data/Data for Neural Networks/M1_DeepSquat/Train_Y1.csv')
    csv_f = csv.reader(f)
    Train_Y = list(csv_f)
    ...
    f = open('../../../data/Data for Neural Networks/M1_DeepSquat/Test_X1.csv')
    csv_f = csv.reader(f)
    Test_X = list(csv_f)
    ...
    f = open('../../../data/Data for Neural Networks/M1_DeepSquat/Test_Y1.csv')
    csv_f = csv.reader(f)
    Test_Y = list(csv_f)
